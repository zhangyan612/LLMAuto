...
workspace_bounds_min = np.array([-0.27499999, -0.65500004,  0.75199986], dtype=np.float32)
workspace_bounds_max = np.array([0.77499999, 0.65500004, 1.75199986], dtype=np.float32)
visualizer.update_bounds(workspace_bounds_min, workspace_bounds_max)
...
def _voxel_to_world(voxel_xyz):
    _voxels_bounds_robot_min = np.array([-0.27499999, -0.65500004,  0.75199986], dtype=np.float32) #[-0.27499999, -0.65500004,  0.75199986] #env.workspace_bounds_min.astype(np.float32)
    _voxels_bounds_robot_max = np.array([0.77499999, 0.65500004, 1.75199986], dtype=np.float32) #[0.77499999, 0.65500004, 1.75199986] #env.workspace_bounds_max.astype(np.float32)
    # _map_size = _map_size
...
def _path2traj(path, rotation_map, velocity_map, gripper_map):
    """
    ...
    for i in range(len(path)):
      ...
      world_xyz = _voxel_to_world(voxel_xyz)
...
def execute(affordance_map, avoidance_map, rotation_map, velocity_map, gripper_map):
    movable_obs = {'name': 'gripper', 'position': np.array([52, 49, 71]), 'aabb': np.array([[52.0, 49.0, 71.0],[52.0, 49.0, 71.0]]), '_position_world': np.array([ 0.27849087, -0.00815093,  1.47194481])}
